...
class Medoo
{
	...
	public static function createInstance($config,$key){
	    if(empty(self::$_instance) || array_key_exists($key,self::$_instance) === false ||!self::$_instance[$key] instanceof self){
	...
	public function insert($table, $datas)
	{
		...
		$this->exec('INSERT INTO ' . $this->tableQuote($table) . ' (' . implode(', ', $fields) . ') VALUES ' . implode(', ', $stack));
		return $this->id();
	}
